---
title: Java基础12：深入理解Class类和Object类
date: 2018-04-30 22:34:51
tags:
categories:
	- 后端
	- Java基础
...
>注意这里说的Class是Java中的java.lang.Class类。这个类用于记录Java中每个类的类型信息，并且jvm在类加载时会为每个类生成一个Class<A>的Class对象在Java堆中，每个A类型的实例都要通过这个Class对象来进行实例化。
...
![image](http://dl.iteye.com/upload/picture/pic/101542/0047a6e9-6608-3c3c-a67c-d8ee95e7fcb8.jpg)
